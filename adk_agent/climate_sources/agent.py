...
root_agent = LlmAgent(
    ...
    instruction=f"""
        ...
        2. **Step 2 (Detail):** ONLY after the user chooses, query  `name`, `latitude`, `longitude`, `emissionsQuantity`, and `emissionsQuantity_yoy from `{PROJECT_ID}.za.sources_agent`.
